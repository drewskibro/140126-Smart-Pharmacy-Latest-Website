...
if ( empty( $faq_items ) || ! is_array( $faq_items ) ) {
	$faq_items = array(
		array( 'question' => 'Is Smart Pharmacy a registered pharmacy?', 'answer' => 'Yes. Smart Pharmacy is operated by Emwhy Pharma Ltd, a UK-based distance-selling pharmacy registered with the General Pharmaceutical Council under registration number 9012842. All medicines are dispensed from our registered premises under the supervision of our superintendent pharmacist. We also work with UK-registered prescribers for all private treatments.' ),
